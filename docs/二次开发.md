...
6. 发版您的版本
    ...
    git tag v2.15.0-beta.8
    git push origin v2.15.0-beta.8
...
chore:升级阿瓦隆版本MFAA_VERSION: "v2.12.1"。3.升级棉絮MXU_VERSION: "v2.1.5"
chore:回退maafw版本5.8.1
chore:升级阿瓦隆版本MFAA_VERSION: "v2.12.1"
chore:升级棉絮MXU_VERSION: "v2.1.5"
